...
def train_random_forest():
    ...
    def train_model_task(feature_path: str) -> None:
        train_model_with_io(features_path=feature_path, model_registry_folder=MODEL_REGISTRY_FOLDER, model_type="random_forest")
...
def train_xgboost():
    ...
    @task
    def train_model_task(feature_path: str) -> None:
        train_model_with_io(features_path=feature_path, model_registry_folder=MODEL_REGISTRY_FOLDER, model_type="xgboost")

    feature_path = prepare_features_task()
    train_model_task(feature_path)

train_random_forest_dag = train_random_forest()
train_xgboost_dag = train_xgboost()